...
<form action="v" method="post" class="form-horizontal">
    ...
    <div class="form-group"><label class="col-lg-2">Nombre de Compañia</label>
        <div class="col-lg-10"><input type="text" name="nameCompany" placeholder="Correo" class="form-control" required/></div></div>
    <div class="form-group"><label class="col-lg-2">Contraseña</label><div class="col-lg-10"><input type="password" name="password" placeholder="Contraseña" class="form-control" required/></div></div>
    <input type="hidden" value="createComp" name="action"/>
    <p align="center"><button input type="submit" class="btn btn-primary">Guardar Y crear</button></p>
</form>
