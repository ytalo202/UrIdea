...
<head>
    ...
    <title>Historial Evaluación</title>
...
<c:forEach var="evaluation" items="${service.findListEvaluatsById((employee.id))}">
        ...
        <div id="<c:out value="${evaluation.id}"/>" class="collapse">
            ...
            <p>Fecha: <c:out value=" ${evaluation.date}"/></p>
                                ...
                                <p>Apellido Paterno    <c:out value=" ${evaluation.idEvaluator.firstLastName} "/>
                                </p>
             <p>Apellido Materno   <c:out value=" ${evaluation.idEvaluator.secondLastName} "/>
                 <a href="TypeEmployeeValidation?action=PerfilAdmin2&idEmployee=<c:out value="${evaluation.idEvaluator.id}"/>">
