        ...
        <!-- /.navbar-collapse -->
            ...
            <div class="my-content" >
                <div class="container" >
                    ...
                    <div class="row">
                        <div class="col-sm-12" >
                            <h1 align="center"><img src="http://icon-icons.com/icons2/20/PNG/256/businessapplication_edit_male_user_thepencil_theclient_negocio_2321.png" width="80px" height="80px"></h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 myform-cont" >
                            ...
                            <div class="myform-bottom">
                                ...
                                <form role="form" action="v" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                     <label class="col-lg-2">Correo</label> <div class="col-lg-10"><input type="email" name="emailData" value="${company.emailAdress.emailData}" placeholder="Correo..." class="form-control" required >
                                    </div></div>
