            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Editar Evaluación de Valores</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="TypeEmployeeValidation" method="post">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">  <input type="radio" name="honesty" value="5"></td>
                                        <td align="center">   <input type="radio" name="honesty" value="8.325">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Organiza sus tiempo de la mejor Manera</td>
                                    ...
                                    <tr>
                                        <td>Es responsable con sus tareas</td>
                                        <td align="center"> <input type="radio" name="responsibility" value="1" checked></td>
                                        <td align="center">   <input type="radio" name="responsibility" value="5">
                                        <td align="center">  <input type="radio" name="responsibility" value="8.325">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Respeta las normas de la empresa</td>
                            ...
                            <br>
                            <input type="hidden" value="createEvaluationIformatica2Editar" name="action"/>
