...
<head>
    ...
    <title>Evaluar Producción</title>
...
<tr>
    ...
    <th>Alto</th>
        ...
        <tr>
            <td>Demostro Honestidad en su centro de labores</td>
        ...
        <tr>
            <td>Organiza bien sus tiempos para cumplir con todas sus tareas</td>
    ...
    <br>
    <input type="hidden" value="createEvaluationProduccion2" name="action"/>
