            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Editar Evaluación de Actitud del Area de Produccion</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="TypeEmployeeValidation" method="post">
                            ...
                            <br>
                            <input type="hidden" value="createEvaluationProduccion1Editar" name="action"/>
