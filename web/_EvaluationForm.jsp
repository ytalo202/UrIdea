...
<form action="eval" method="post">
    ...
    <input type="text" name="id_company" value=" ${evaluation.company.nameCompany}"
        <c:out value="${action == 'edit' ? 'readonly=\"readonly\"' : '' }"/>
            />
    <input type="text" name="id_evaluator" value=" Evaluador ${evaluation.idEmployee.name} "
            <c:out value="${action == 'edit' ? 'readonly=\"readonly\"' : '' }"/>
    />
    <input type="text" name="id_user_employee" value=" Evaluado ${evaluation.idUserEmployee.name}"
            <c:out value="${action == 'edit' ? 'readonly=\"readonly\"' : '' }"/>
    />
